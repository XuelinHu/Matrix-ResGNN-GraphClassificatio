...
The implementation uses Python 3.11.14, PyTorch 2.5.1, PyTorch Geometric 2.7.0, NumPy 2.0.1, pandas 2.3.3, scikit-learn 1.9.0, and Matplotlib 3.10.8 in the Conda environment \texttt{pyg}. The current repository verification and manuscript regeneration were performed on Microsoft Windows 10 64-bit with an Intel Core Ultra 9 285H processor, 16 physical/logical cores, approximately 32 GB system memory, and an Intel Arc 140T GPU. The repository stores the scripts, configuration files, frozen logs, generated figures, and supporting evidence needed to audit the reported experiments.
