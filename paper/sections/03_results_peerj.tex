...
All results are reported as five-fold mean best test accuracy \(\pm\) fold-level standard deviation unless otherwise stated. The source tables are the summaries under \texttt{records/LATEST} for the real-data experiments and \texttt{records/SYN\_MULTI\_FULL} for the synthetic multi-class benchmark. The main benchmark contains 600 completed runs, and the synthetic multi-class benchmark contains 3,500 completed runs.
